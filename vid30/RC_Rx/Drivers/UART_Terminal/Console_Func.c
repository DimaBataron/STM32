...
/*
 *  оманда управл€ет задачей вывода в UART интересующих данных.
 * ¬ зависимости от прин€той команды измен€ет глобальную переменную.
 * Ёта глобальна€ переменна€ используетс€ в задаче дл€ вывода инфы.
 * 0 - вывод остановлен
 * 1 - вывод каждую секунду прин€тых отклонений стиков.
 * 2 - каждых 2 секунды
 * 3 - каждые 3 секунды.
 * ћожно добавить новые цифры дл€ вывода.
 *
 */
