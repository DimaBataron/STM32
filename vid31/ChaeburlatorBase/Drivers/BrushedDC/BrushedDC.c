...
/*
 * ѕлавное управление одним двигателем. ( ¬ызывал обычно каждых 20м—
 * работало все норм)
 */
...
/*
 * ‘ункци€ возвращает приращение на которое нужно изменить ускорение.
 * ≈сли изменение на 1 ничего не делать.
 */
